...
In a terminal or command window, navigate to the current level project directory `finding_donors/charity_ml` (that contains this README) and run one of the following commands:
